package org.luigilp.ezChestShop.command;
...
import org.luigilp.ezChestShop.EzChestShop;
import org.luigilp.ezChestShop.model.Shop;
import org.luigilp.ezChestShop.session.CreateSession;
import org.luigilp.ezChestShop.util.ItemUtils;
import org.luigilp.ezChestShop.util.MoneyParser;
...
public final class EzChestShopCommand implements CommandExecutor, TabCompleter {

    private final EzChestShop plugin;

    public EzChestShopCommand(EzChestShop plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sub.equals("reload")) {
            ...
            plugin.reloadAll();
            sender.sendMessage("EzChestShop reloaded.");
            return true;
        }
